...
O botão "Sair" leva direto para a tela inicial, sem confirmação: como não há conta nem dado sensível atrás dele, um toque acidental só significa reabrir o mesmo perfil na tela seguinte — nada se perde.
